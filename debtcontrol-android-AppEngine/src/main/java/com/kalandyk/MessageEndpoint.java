 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "kalandyk.com", ownerName = "kalandyk.com", packagePath = ""))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyB8qMMEMPfuBkCQkdmVAbvL-VPGxbcxr7E";
